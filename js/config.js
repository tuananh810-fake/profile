export const APP_CONFIG = {
    ...
    lyrics: {
        ...
        display: {
            ...
            defaultLyricDelayMs: 0,
            minLyricDelayMs: -900,
            maxLyricDelayMs: 900,
            lyricDelayStepMs: 25,
            defaultSmoothMode: true,
            ...
            defaultKineticTailBurstParticles: 48,
            minKineticTailBurstParticles: 0,
            maxKineticTailBurstParticles: 180,
            kineticTailBurstParticlesStep: 4,
            defaultKineticTailBurstSpread: 1,
            minKineticTailBurstSpread: 0.2,
            maxKineticTailBurstSpread: 2.2,
            kineticTailBurstSpreadStep: 0.05,
            defaultKineticTailBurstGravity: 0.65,
            minKineticTailBurstGravity: -1,
            maxKineticTailBurstGravity: 2,
            kineticTailBurstGravityStep: 0.05,
            defaultKineticTailBurstDuration: 0.8,
            minKineticTailBurstDuration: 0.2,
            maxKineticTailBurstDuration: 1.8,
            kineticTailBurstDurationStep: 0.05,
            minTextScale: 0.6,
            maxTextScale: 3.4,
            scaleStep: 0.04,
